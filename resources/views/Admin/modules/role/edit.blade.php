        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.role.update',['id'=>$role->id]) }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="name" value="{{$role->name}}" class="form-control @error('config_key') is-invalid @enderror" placeholder="Enter Name">
                  @error('config_key')
                ...
                <div class="mb-3">
                  ...
                  <textarea name="display_name" role="10" rows="10" class="form-control @error('config_value') is-invalid @enderror" placeholder="Enter Display Name">
                  {{$role->display_name}}
                </textarea>
                  @error('config_value')
                     <div class="alert alert-danger">{{ $message }}</div>
                        ...
                        <div class="card-body">
                           <div class="row">
                              @foreach ($permissionsParentItem->permissionsChildrent as $permissionsChildrentItem)
                               <div class="col-md-3">
                                    <label for="">
                                        <input type="checkbox" class="checkbox_chilrent" name="permission_id[]"
